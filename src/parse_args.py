...
parser.add_argument('--te_start', type=bool, default=False, help='re_start')
...
parser.add_argument('--same_start', type=bool, default=False,
                    help='use entity embedding to init abs path (default: False)')
